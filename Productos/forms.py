...
from .models import IngresoProducto2, Producto, IngresoProducto, Producto2
...
class IngresoProductoForm(forms.ModelForm):
   ...
   # Tienda 2 - Control Interno de Productos
class Producto2Form(forms.ModelForm):
    class Meta:
        model = Producto2   # ✅ CORRECTO
        fields = ['nombre', 'medida', 'precio_compra', 'precio_venta', 'id_cate', 'tienda', 'insumo', 'imagen']
...
class UpdateProducto2Form(forms.ModelForm):
    class Meta:
        model = Producto2   # ✅ CORRECTO
        fields = ['nombre', 'medida', 'precio_compra', 'precio_venta', 'id_cate', 'tienda', 'estado', 'imagen']
...
class IngresoProducto2Form(forms.ModelForm):
    class Meta:
        model = IngresoProducto2
        fields = ['cantidad', 'salida', 'precio_compra', 'observacion', 'fecha_ingreso']
        ...
        widgets = {
            ...
            'salida': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': '0',
